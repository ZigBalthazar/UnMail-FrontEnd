...
export default function Email() {
  ...
  const SendClickHandler = () => {
    ...
    if (EmailValidation && ContextValue.SubjectValue && ContextValue.TextValue) {
      const data = {
        to: ContextValue.EmailValue,
        text: ContextValue.TextValue,
        subject: ContextValue.SubjectValue,
      };
      fetch(`https://keyhangard.ir/mail`, {
        method: "POST",
        headers: {
      ...
      <main>
        <nav>
          <div className="d-flex align-items-center">
            ...
            <a href="https://t.me/REPORT_BUGS" className="mx-2">
              report bugs
            </a>
          </div>
          ...
          <div>
            ...
            <label for="timeOffcanvas" class="toggle_btn ">
              Night
            </label>
          </div>
        </nav>
        ...
        <a href="https://t.me/keyhangard">
          <img width="50" height="50" className="keyhan-logo" src={!darkMode ? "images/kg-logo-transw.png" : "images/kg-logo-transparent (1).png"} alt="keyhanLogo" />
        </a>
      </main>
    </>
  );
